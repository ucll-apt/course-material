...
if os.path.isfile(zipfile_name):
    ...
    print('Please get rid of it first and the run this script again')
    sys.exit(-1)


directories = [directory for directory in os.listdir('.') if os.path.isdir(directory) and directory != 'node_modules']
...
solution_files = [os.path.join(directory, solution_filename) for directory in directories]
